...
namespace Loscate.Site.Controllers.Social.Message.Tests
{
    ...
    public class GetDialogMessagesControllerTests
    {
        ...
        public void GetByWrongUidTest()
        {
            ...
            var controller = new GetDialogMessagesController(mockContextDb.Object, mockUserService.Object);
            var result = controller.Get(testUser2.Uid);
            Assert.IsNull(result);
        }


        [TestMethod()]
        public void GetNonExistDialogTest()
        {
            var testUser1 = new FirebaseUser { Id = testUserId1, Uid = testUserUid1 };
            var testUser2 = new FirebaseUser { Id = testUserId2, Uid = testUserUid2 };
        ...
        public void GetCorrectDialogTest()
        {
            ...
            Assert.AreEqual(result[0].SendUser.Name, testUser2.Name);
            Assert.AreEqual(result[0].Text, testMessageText);
        }
    }
}