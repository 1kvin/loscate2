...
namespace Loscate.App.ApiRequests.Map
{
    ...
    {
        public static async Task<string> DelPin(IFirebaseAuthenticator firebaseAuthenticator, int pinId)
        {
            return await ApiRequest.MakeRequest<string>(firebaseAuthenticator, $"api/map/delPin?id={pinId}");
        }
        ...
        public static async Task<List<DTO.Map.Pin>> SearchPin(IFirebaseAuthenticator firebaseAuthenticator, string filter)
        {
            return await ApiRequest.MakeRequest<List<DTO.Map.Pin>>(firebaseAuthenticator, $"api/map/searchPin?filter={filter}");
        }
